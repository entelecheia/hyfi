...
from hyfi.cached_path._cached_path import cached_path, get_from_cache
from hyfi.cached_path.meta import Meta
from hyfi.cached_path.schemes.http import HttpClient, RecoverableServerError
from hyfi.cached_path.testing import BaseTestClass
from hyfi.cached_path.util import _lock_file_path, _meta_file_path, resource_to_filename
    ...
    def test_http_200(self):
        ...
        with pytest.raises(FileNotFoundError):
            filename = cached_path(
                self.FIXTURES_ROOT / "does_not_exist" / "fake_file.tar.gz"
            )
